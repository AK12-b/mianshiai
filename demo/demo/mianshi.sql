...
CREATE TABLE `interview_wrong_question`  (
  ...
  `wrong_reason` tinyint(1) NULL DEFAULT NULL COMMENT '失分原因（用户手动选择）：1=知识点遗漏，2=逻辑混乱，3=表达失误，4=思路错误',
...
CREATE TABLE `mock_interview`  (
  ...
  `ai_character` tinyint(1) NOT NULL COMMENT 'AI面试官性格：1=温柔亲和型，2=压力型，3=正常严谨型',
